...
#
# Lab2_part2.tcl: Tcl script for re-creating project 'Lab2_part2'
#
# Generated by Vivado on Wed Sep 21 13:21:21 PDT 2022
...
#
# 1. This project restoration tcl script (Lab2_part2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/troy/fa22-e524-lab2-troykerim/hardware/Lab2_part2/fahr_to_cel_tb.vhd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/troy/fa22-e524-lab2-troykerim/hardware/src/fahr_to_cel.vhd"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Lab2_part2/fahr_to_cel_tb.vhd"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../src/fahr_to_cel.vhd"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "Lab2_part2"
...
set script_file "Lab2_part2.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../Lab2_part2"]"
...
set file "$origin_dir/../src/fahr_to_cel.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "fahr_to_cel" -objects $obj
...
set file "Lab2_part2/fahr_to_cel_tb.vhd"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "fahr_to_cel_tb" -objects $obj
